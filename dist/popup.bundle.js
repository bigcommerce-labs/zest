              ...
              (() => {
                ...
                function b(e) {
                  e.children.forEach((e) => {
                    e.el.classList.add(g), e.isExpanded && b(e);
                  });
                }
                function E(e) {
                  e.children.forEach((e) => {
                    e.el.classList.remove(g), e.isExpanded && E(e);
                  });
                }
                function S(e) {
                  if (e.children.length > 0) {
                    const n = e.el.querySelector(".fas");
                    n && n.classList.replace(x, j);
                  }
                }
                function k(e) {
                  if (e.children.length > 0) {
                    const n = e.el.querySelector(".fas");
                    n && n.classList.replace(j, x);
                  }
                }
                function w(e) {
                  e.isExpanded
                ...
                function P(e, n) {
                  ...
                  L(e, function (e) {
                    (e.el = (function (e) {
                      ...
                      return (
                        null !== e.parent && r.classList.add(g),
                ...
                function q(e) {
                  L(e, function (e) {
                    e.el.classList.remove(g), (e.isExpanded = !0), S(e);
                  });
                }
                function I(e) {
                  L(e, function (n) {
                    (n.isExpanded = !1),
                      n.depth > e.depth && n.el.classList.add(g),
                      k(n);
                  });
                }
                function A(e) {
      ...
      console.log("This is a popup!"),
        chrome.tabs.query({ active: !0, currentWindow: !0 }, function (e) {
          ...
          console.log("current tab"),
            chrome.runtime
              .sendMessage({ action: "inject-content-script", tabId: n.id })
              .then((e) => {
                console.log(e.msg);
              });
        }),
        document.addEventListener("DOMContentLoaded", function () {
          ...
          const e = document.getElementById("action-get-primary-cart");
          e.addEventListener("click", () => {
            chrome.tabs.query({ active: !0, currentWindow: !0 }, function (t) {
              ...
              console.log(r, e),
                chrome.tabs
                  .sendMessage(r.id, { action: "get-primary-cart" })
                  .then((e) => {
                    console.log(e),
                      (document.querySelector(".json-container").innerHTML =
                        "");
                    const t = n().create(e.json);
                    n().render(t, document.querySelector(".json-container"));
                  });
            });
          });
        });
